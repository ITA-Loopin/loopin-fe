    ...
    <div className="flex flex-col min-h-full">
          ...
          <button
            ...
            className={`flex-1 py-3 text-body-2-sb transition-colors ${
              activeTab === "my"
                ...
                ? "text-gray-700 border-b-1 border-gray-700"
      ...
      <main className="flex-1 px-4 py-6">
        ...
        <div className="mb-6">
          ...
          {/* 목표 */}
          { }
          <h2 className="text-title-2-b text-gray-black">{goal}</h2>
        </div>
        ...
        {activeTab !== "calendar" && (
          <div className="mb-6 flex justify-center">
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative flex h-9 self-stretch items-center justify-center gap-[10px] rounded-[5px] bg-white/50 backdrop-blur-[0px] px-3 py-[7px] text-body-2-b text-gray-700 shadow-[0_0_7px_0_rgba(0,0,0,0.05)]">
                {/* 삼각형 포인터 */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
        ...
        <div className="flex justify-center">
          {activeTab === "team" ? (
            <button
              ...
              className="flex w-full h-9 px-2 py-1.5 justify-center items-center gap-2 rounded-[5px] bg-gray-200 text-body-2-sb text-gray-600 whitespace-nowrap"
            >
              팀 활동 기록보기
            </button>
          ) : (
